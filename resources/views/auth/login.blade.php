                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">               
                            <div class="d-flex justify-content-center py-4">
                                <a href="#" class="d-flex align-items-center w-auto">
                                    <img src="{{ asset('public/NiceAdmin/assets/img/Logo-RSPR-2024.png') }}" height="75">
                                    <!--
                          ...
                          <div class="card mb-3">
                                <div class="card-body">                                
                                    ...
                                    <div class="pt-2 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">BARANG SIRS</h5>
                                        <p class="text-center small">RS. Paru Dr. H. A. Rotinsulu</p>
                                    </div>

                                    <!--
                                    <form class="row g-3 needs-validation" novalidate action="/proses_login" method="post">
                                    -->
                                    <form class="row g-3" action="{{ url('/proses_login') }}" method="post">
                                    {{ csrf_field() }}
                                        <div class="col-12">
